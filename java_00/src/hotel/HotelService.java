...
public class HotelService {
	...
	public void startprogram() {
		...
		while (true) {
			...
			default :
				System.out.println("1~4까지의 정수를 선택해 주세요.");
				break;			
			}
		}
	}
	...
	public void checkOut() {
		...
		System.out.println("퇴실할 객실을 선택해주세요.");
		int roomNum = sc.nextInt();
		
		hotelDAO.checkOut(roomNum);
		System.out.println("행복한 오늘 되세요~");	
	}
	...
	public void roomInfo() {
		...
		for(Room r : rooms) {
			if(r.isUsing() == true) {
				...
				System.out.println(cnt + "호 객실은 비어 있습니다.");
			}
				cnt++;			
		}
